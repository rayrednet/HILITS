...
(4,'Enhancing Evaporation of Produced Brine Water','NineSigma, representing ExxonMobil Technology and Engineering Company (“ExxonMobil”), invites proposals for novel technologies that could increase the evaporation rate of produced water (Brines) in order to significantly reduce current volumes (millions of gallons per day).', 'NineSigma, ExxonMobil, Produced Water, Evaporation, Brine', 'NineSigma (USA)', ' vranken@ninesigma.com', NULL, 2),
(5,'Adaptive Learning through Personalised Assessments and Trainings Digital Tool','QRDI and MATAR, are working together to address bottlenecks within HR training and development through innovative adaptive and personalized programs for each employee. This innovation call aims to assist MATAR Human Resources (HR) Talent Development team provide a more effective learning and development experience for employees by understanding what competencies need to be strengthened to better fulfil their role or prepare for their next career move. The vision is an AI generated metacognitive assessment yielding a solution for competency improvement through the provision of personalized adaptive micro learning (<5mins) to be generated using AI driven technology and trained using MATAR trainings, documents, videos & audio clips. QRDI and MATAR invites proposals from startups, SMEs, and corporates for Adaptive Learning through Personalised Assessments and Trainings Digital Tool prize challenge.', 'Adaptive Learning, HR, Human Resources, AI', 'QRDI and MATAR (QAT)', 'https://qrdi-org-qa.zoom.us/webinar/register/WN_lIoMuKQoTtOa1-xKNiCFCQ', NULL, 2),
-- TEMPLATE
-- (4,'','', '', '', '', NULL, 2),
